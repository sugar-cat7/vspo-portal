...
export class DiscordClient implements IDiscordClient {
  ...
  async sendMessage(
    ...
    return withTracer("discord", "sendMessage", async (span) => {
  ...
  async getChannel(
    ...
    return withTracer("discord", "getChannel", async (span) => {
  ...
  async updateMessage(
    ...
    return withTracer("discord", "updateMessage", async (span) => {
  ...
  async deleteMessage(
    ...
    return withTracer("discord", "deleteMessage", async (span) => {
  ...
  async getLatestBotMessages(
    ...
    return withTracer("discord", "getLatestBotMessages", async (span) => {
  ...
  async getMessage(
    ...
    return withTracer("discord", "getMessage", async (span) => {
      const { channelId, messageId } = params;
