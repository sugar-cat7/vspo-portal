...
export class YoutubeService implements IYoutubeService {
  ...
  async getVideos(params: GetVideosParams): Promise<Result<Videos, AppError>> {
    return withTracer("YoutubeService", "getVideos", async (span) => {
  ...
  async searchVideos(
    ...
    return withTracer("YoutubeService", "searchVideos", async (span) => {
      const responseResult = await wrap(
  ...
  async getChannels(
    ...
    return withTracer("YoutubeService", "getChannels", async (span) => {
