	...
	default:
		...
		case '/': // Prefix: "/"
			...
			case 'c': // Prefix: "c"
				...
				case 'l': // Prefix: "lips"
					if l := len("lips"); len(elem) >= l && elem[0:l] == "lips" {
						elem = elem[l:]
					} else {
						break
					}
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleClipsGetRequest([0]string{}, elemIsEscaped, w, r)
						case "PUT":
							s.handleClipsPutRequest([0]string{}, elemIsEscaped, w, r)
						default:
			...
			case 's': // Prefix: "songs"
				...
				if len(elem) == 0 {
					...
					case "PUT":
						s.handleSongsPutRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, "GET,POST,PUT")
					}
				...
				case 'l': // Prefix: "lips"
					...
					if len(elem) == 0 {
						...
						case "PUT":
							// Leaf: ClipsPut
							r.name = "ClipsPut"
							r.summary = "Update clips from YouTube"
							r.operationID = ""
							r.pathPattern = "/clips"
							r.args = args
							r.count = 0
			...
			case 's': // Prefix: "songs"
				...
				if len(elem) == 0 {
					...
					case "POST":
						// Leaf: SongsPost
						r.name = "SongsPost"
						r.summary = "Create Song from Youtube"
						r.operationID = ""
						r.pathPattern = "/songs"
						r.args = args
						r.count = 0
					...
					case "PUT":
						// Leaf: SongsPut
						r.name = "SongsPut"
						r.summary = "Update songs from Youtube"
						r.operationID = ""
						r.pathPattern = "/songs"
						r.args = args
						r.count = 0
