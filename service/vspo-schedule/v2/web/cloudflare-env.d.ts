/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 8998da0240592d3834e2145208fefa99)
...
declare namespace Cloudflare {
  interface Env {
    ...
    NEXT_PUBLIC_ADS_GOOGLE: string;
    NEXT_PUBLIC_FORM: string;
    NEXT_PUBLIC_DISCORD_LINK: string;
    NEXT_PUBLIC_GOOGLE_ANALYTICS: string;
    NEXT_PUBLIC_AD_SLOT: string;
    NEXT_PUBLIC_AD_CLIENT: string;
    ASSETS: Fetcher;
  }
}
